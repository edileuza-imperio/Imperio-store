...
export const rotas = {
  ...
  categorias: {
    ...
    publicas: "/categorias-publicas",
    publicasPorSite: (siteConfigId: Id) => `/categorias-publicas/${siteConfigId}`,
    criar: "/categoria",
  ...
  usuarios: {
    ...
    enderecoPrincipal: "/usuario/endereco/principal",
    buscarEndereco: (id: Id) => `/usuario/endereco/${id}`,
    atualizarEndereco: (id: Id) => `/usuario/endereco/${id}`,
    enderecoPrincipalDefinir: (id: Id) => `/usuario/endereco/${id}/principal`,
    deletarEndereco: (id: Id) => `/usuario/endereco/${id}`,
  ...
  painel: {
    ...
    produtoCadastrar: "/painel/produto",
  ...
  footer: {
    publico: "/footer",
    publicoPorSite: (siteConfigId: Id) => `/footer/site/${siteConfigId}`,
    listar: "/footers",
    buscar: (id: Id) => `/footer-admin/${id}`,
    buscarPorSiteConfig: (siteConfigId: Id) =>
      `/footer/site-config/${siteConfigId}`,
    completo: (siteConfigId: Id) => `/footer/completo/${siteConfigId}`,
  },
